 ...
 */
package org.beangle.webui.app.config

import org.beangle.commons.inject.bind.AbstractBindModule
import org.beangle.webui.app.config.action.{ ContainerAction, DependencyAction, FreemarkerAction, IndexAction, MvcAction, WebinitAction }
